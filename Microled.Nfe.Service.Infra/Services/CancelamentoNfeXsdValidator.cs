...
public class CancelamentoNfeXsdValidator
{
    private const string SchemaFolderRelativePath = "XSD/schemas-reformatributaria-v02-3";
    private const string RootSchemaFileName = "PedidoCancelamentoNFe_v02.xsd";

    private readonly ILogger<CancelamentoNfeXsdValidator> _logger;
    private XmlSchemaSet? _schemaSet;

    public CancelamentoNfeXsdValidator(ILogger<CancelamentoNfeXsdValidator> logger)
    {
    ...
    public void Validate(string xmlContent)
    {
        ...
        {
            var message = $"PedidoCancelamentoNFe failed XSD validation: {string.Join(" | ", validationErrors)}";
    ...
    private XmlSchemaSet CreateSchemaSet()
    {
        ...
        _logger.LogInformation(
            "CancelamentoNFe XSD validation loaded from root schema {RootSchemaPath}",
            rootSchemaPath);
        return schemaSet;
    }
